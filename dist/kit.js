...
// -----------------------------------------------------------------------------
const Page = ({ title, description, actions, children }) => {
    ...
    }, React.createElement('div', { style: { flex: '1 1 auto', minWidth: '200px' } }, title && React.createElement('h1', {
        style: {
            fontSize: '24px',
            fontWeight: '600',
...
// -----------------------------------------------------------------------------
const Button = ({ variant = 'primary', size = 'md', loading, disabled, type = 'button', onClick, children }) => {
...
const Input = ({ label, type = 'text', placeholder, value, onChange, error, disabled, required, className }) => {
    ...
    }, label, required && React.createElement('span', { style: { color: colors.error.default, marginLeft: '4px' } }, '*')), React.createElement('input', {
        type,
        value,
...
const TextArea = ({ label, placeholder, value, onChange, rows = 4, error, disabled, required }) => {
    ...
    }, label, required && React.createElement('span', { style: { color: colors.error.default, marginLeft: '4px' } }, '*')), React.createElement('textarea', {
        value,
        onChange: (e) => onChange(e.target.value),
        placeholder,
        rows,
...
// -----------------------------------------------------------------------------
const Select = ({ label, options, value, onChange, placeholder, error, disabled, required }) => {
    return React.createElement('div', {
        style: { display: 'flex', flexDirection: 'column', gap: '6px' },
    }, label && React.createElement('label', {
        style: {
    ...
    }, label, required && React.createElement('span', { style: { color: colors.error.default, marginLeft: '4px' } }, '*')), React.createElement('div', { style: { position: 'relative' } }, React.createElement('select', {
        value,
        onChange: (e) => onChange(e.target.value),
        disabled,
        style: {
    ...
    }, placeholder && React.createElement('option', { value: '', disabled: true }, placeholder), options.map((opt) => React.createElement('option', { key: opt.value, value: opt.value, disabled: opt.disabled }, opt.label))), React.createElement('div', {
        style: {
            position: 'absolute',
            right: '12px',
            top: '50%',
    ...
    }, React.createElement(ChevronDown, { size: 16 }))), error && React.createElement('p', {
        style: { fontSize: '12px', color: colors.error.default, margin: 0 },
    }, error));
};
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
const Table = ({ columns, data, onRowClick, emptyMessage = 'No data found', loading }) => {
    if (loading) {
        return React.createElement('div', {
            style: {
                display: 'flex',
    ...
    return React.createElement('div', { style: { overflowX: 'auto' } }, React.createElement('table', {
        style: {
            width: '100%',
    ...
    }, col.label)))), React.createElement('tbody', null, data.map((row, rowIndex) => React.createElement('tr', {
        key: rowIndex,
...
const Alert = ({ variant, title, onClose, children }) => {
    ...
    }, React.createElement(Icon, { size: 20, style: { color, flexShrink: 0, marginTop: '1px' } }), React.createElement('div', { style: { flex: 1, minWidth: 0 } }, title && React.createElement('h4', {
        style: {
            fontSize: '14px',
            fontWeight: '600',
            color,
...
const Modal = ({ open, onClose, title, description, size = 'md', children }) => {
    ...
    }, React.createElement('div', null, title && React.createElement('h2', {
        style: {
            fontSize: '18px',
            fontWeight: '600',
            color: colors.text.primary,
...
const Dropdown = ({ trigger, items, align = 'left' }) => {
    ...
    return React.createElement('div', { style: { position: 'relative', display: 'inline-block' } }, React.createElement('div', {
        onClick: () => setOpen(!open),
        style: { cursor: 'pointer' },
    }, trigger), open && React.createElement(React.Fragment, null, React.createElement('div', {
